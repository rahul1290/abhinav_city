            					...
            					<form name="f1" method="POST" action="<?php echo base_url('property_ctrl/create');?>">
            						<div class="form-row">
            							<div class="col-5">
            								<div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                								  ...
                								  <div class="text-danger" id="category_error" style="display: none;"></div>	
                                                </div>
                                            </div>
                                            ...
                                            <?php if(isset($property_detail)){ 
                                                ...
                                                <div class="col-sm-9">
                                                  	<input type="text" class="form-control" id="plot_no" name="plot_no" value=
                                                  	"<?php if(isset($property_detail)){
                                                  	    echo $property_detail[0]['block'];
                                                  	}?>" placeholder="plot no">
                									<div class="text-danger" id="plot_no_error" style="display: none;"></div>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row" id="blockno" style="display: <?php if(isset($property_detail)){
                                                if($property_detail[0]['category'] != 'plot'){
                                                    echo 'flex';
                                                } else {
                                                    echo 'none';
                                                ...
                                                <div class="col-sm-9">
                									...
                									<div class="text-danger" id="block_error" style="display: none;"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                    								...
                    								<div class="text-danger" id="facing_error" style="display: none;"></div>
                                                </div>
                                            </div>
                                            
                                        	<div class="form-group row" id="nonplot_area" style="display:<?php if(isset($property_detail)){
                                        	    if($property_detail[0]['category'] != 'plot'){
                                        	        echo 'none';
                                        	    } else {
                                        	        echo 'flex';
                                                ...
                                                <div class="col-sm-9">
            										...
            										<div class="text-danger" id="area_error" style="display: none;"></div>
                                                </div>
                                            </div>
                                            ...
                                            <?php if(isset($property_detail)){
                                                ...
                                                <div class="col-sm-8">
                                                  	<input type="text" name="rate_of_plot" id="rate_of_plot" placeholder="Rate of plot" value=
                                                  	"<?php if(isset($property_detail)){
                                                  	    echo $property_detail[0]['rate_plot'];
                                                  	}?>" class="form-control" />
                									<div class="text-danger" id="rate_of_plot_error" style="display: none;"></div>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row" id="construction_area_block" style="display: <?php if(isset($property_detail)){
                                                if($property_detail[0]['category'] == 'plot'){
                                                    echo 'none';
                                                } else {
                                                    echo 'flex';
                                                ...
                                                <div class="col-sm-8">
                                                  	<input type="text" class="form-control" id="construction_area" name="construction_area" placeholder="Construction area in sqft" value=
                                                  	"<?php if(isset($property_detail)){
                                                  	    echo $property_detail[0]['area'];
                                                  	}?>" />
                                                  	<div class="text-danger" id="construction_area_error" style="display: none;"></div>
                                                </div>
                                            </div>
                                                
                                            <div class="form-group row" id="block_rate" style="display: <?php if(isset($property_detail)){
                                                if($property_detail[0]['category'] == 'plot'){
                                                    echo 'none';
                                                } else {
                                                    echo 'flex';
                                                ...
                                                <div class="col-sm-8">
                                                  	<input type="text" id="rate_of_block" name="rate_of_block" placeholder="Rate of block" value=
                                                  	"<?php if(isset($property_detail)){
                                                  	    echo $property_detail[0]['rate_plot'];
                                                  	}?>"	
                                                  	 class="form-control" />
                									<div class="text-danger" id="rate_of_block_error" style="display: none;"></div>
                                                </div>
                                            </div>
            							...
            							<div class="offset-1 col-5">
            								<div class="form-group row pb-2" id="bhk_box" style="display: <?php if(isset($property_detail)){
            								    if($property_detail[0]['category'] == 'plot'){
            								        echo 'none';
            								    } else {
            								        echo 'flex';
                                                ...
                                                <div class="col-sm-10">
                                                  	<select name="bhk" id="bhk" class="form-control">
                                                  		...
                                                  		<option value="1bhk" <?php if(isset($property_detail)){
                                                  		    if($property_detail[0]['property_type'] == '1bhk'){
                                                  		        echo 'selected';
                                                  		    }
                                                  		}?>>1 BHK</option>
                                                  		<option value="2bhk" <?php if(isset($property_detail)){
                                                  		    if($property_detail[0]['property_type'] == '2bhk'){
                                                  		        echo 'selected';
                                                  		    }
                                                  		}?>>2 BHK Duplex</option>
                                                  		<option value="3bhk" <?php if(isset($property_detail)){
                                                  		    if($property_detail[0]['property_type'] == '3bhk'){
                                                  		        echo 'selected';
                                                  		    }
                                                  		}?>>3 BHK Duplex</option>
                                                  	</select>
            										<div class="text-danger" id="bhk_error" style="display: none;"></div>
                                                </div>
                                                <br/>
                                            </div>
                                            ...
                                            <div class="p-2" style="border: 1px solid #e0dcdc">
            									...
            									<div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      	<input type="text" id="maintenance" name="maintenance" placeholder="Maintenance cost in rs." value=
                                                      	"<?php if(isset($property_detail)){
                								...
                								<div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      	<input type="text" name="club_house" id="club_house" placeholder="Club house cost in rs." value=
                                                      	"<?php if(isset($property_detail)){
                                                      	    echo $property_detail[0]['club_house'];
                                                      	}?>" class="form-control" />
            											<div class="text-danger" id="club_house_error" style="display: none;"></div>
                                                    </div>
                                                </div>
                                                
                								<label>Transformer/Electricity</label> 
                                                <div class="input-group mb-3">
                                                  <input type="text" name="trans_elec" id="trans_elec" placeholder="Transform/Electricity cost in rs." class="form-control" value=
                                                  "<?php if(isset($property_detail)){
            								...
            								<div class="input-group mb-3">
                                                  <div class="form-check">
                                                      <input class="form-check-input" type="checkbox" data-pid="<?php echo $property_detail[0]['pid']; ?>"  id="property_hold_checkbox" name="hold"
                                                      <?php if(isset($property_detail)){
                                                  ...
                                                  &nbsp;&nbsp;&nbsp;&nbsp;
                                                  <div class="form-check">
                                                      <input class="form-check-input" data-pid="<?php echo $property_detail[0]['pid']; ?>" id="property_booking__checkbox" type="checkbox" name="booked"
                                                      <?php if(isset($property_detail)){
                                            ...
                                            <label class="mt-2">Total Cost : <span id="total_cost">
                                            	...
                                            	if(isset($property_detail)){
                                            	   ...
                                            	   $totalCost += $property_detail[0]['rate_plot'];
                                            	   if($property_detail[0]['corner'] == '1'){
                                            	       $totalCost += ($property_detail[0]['rate_plot'] * 5)/100;
                                            	   }
                                            	   if($property_detail[0]['garden'] == '1'){
                                            	       $totalCost += ($property_detail[0]['rate_plot'] * 5)/100;
                                            	   }
            								...
            								<div class="text-center mt-4">
            									<?php if($this->uri->segment(2) != ''){ ?>
            										<input type="button" id="update" data-pid="<?php echo $property_detail[0]['pid']; ?>" value="Update" class="btn btn-success" />
            									<?php } else { ?>
                    								<input type="button" id="create" value="Submit" class="btn btn-success" />
                    							<?php } ?> 
                		...
                		<table border="0" width="100%" id="customer_detail_table">
                			<tr>
                				...
                				<td>
                					...
                					<input type="text" class="form-control" name="plot" id="plot_name" value="" readonly/>
                				</td>
                			</tr>
                			<tr>
                				<td>Client Name:</td>
